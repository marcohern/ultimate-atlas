...
const routes: Routes = [
    ...
    { path: 'daily/accs/add' ,  component: AccDetailComponent , canActivate: [AuthorizedGuard] },
    { path: 'daily/accs/:id' ,  component: AccDetailComponent , canActivate: [AuthorizedGuard] },
